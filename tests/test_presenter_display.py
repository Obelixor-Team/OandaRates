...
SAMPLE_RAW_DATA = {
    "financingRates": [
        {"instrument": "EUR_USD", "longRate": 0.01, "shortRate": -0.02, "currency": "USD", "days": 1, "longCharge": "", "shortCharge": "", "units": ""},
        {"instrument": "XAU_USD", "longRate": 0.05, "shortRate": -0.06, "currency": "USD", "days": 1, "longCharge": "", "shortCharge": "", "units": ""},
        {"instrument": "WTICO_USD", "longRate": 0.10, "shortRate": -0.11, "currency": "USD", "days": 1, "longCharge": "", "shortCharge": "", "units": ""},
        {"instrument": "US30_USD", "longRate": 0.02, "shortRate": -0.03, "currency": "USD", "days": 1, "longCharge": "", "shortCharge": "", "units": ""},
        {"instrument": "DE10YB_EUR", "longRate": 0.005, "shortRate": -0.006, "currency": "EUR", "days": 1, "longCharge": "", "shortCharge": "", "units": ""},
        {"instrument": "SOME_INSTRUMENT_CFD", "longRate": 0.03, "shortRate": -0.04, "currency": "USD", "days": 1, "longCharge": "", "shortCharge": "", "units": ""},
        {"instrument": "UNKNOWN", "longRate": 0.07, "shortRate": -0.08, "currency": "GBP", "days": 1, "longCharge": "", "shortCharge": "", "units": ""},
    ]
}
...
def test_update_display_with_raw_data_no_filter(presenter_instance, mock_view):
    ...
    mock_view.set_status.assert_called_once_with("Display updated. Showing 7 instruments.")
...
def test_update_display_with_filter_text(presenter_instance, mock_view):
    ...
    mock_view.update_table.assert_called_once_with(expected_data)
    mock_view.set_status.assert_called_once_with("Display updated. Showing 2 instruments.")
...
def test_update_display_with_selected_category(presenter_instance, mock_view):
    ...
    mock_view.update_table.assert_called_once_with(expected_data)
    mock_view.set_status.assert_called_once_with("Display updated. Showing 1 instruments.")
...
def test_update_display_currency_inference(presenter_instance, mock_view):
    presenter_instance.raw_data = {
        "financingRates": [
            {"instrument": "AUD/CAD", "longRate": 0.01, "shortRate": -0.02, "currency": "CAD", "days": 1, "longCharge": "", "shortCharge": "", "units": ""},
            {"instrument": "GBP_USD", "longRate": 0.01, "shortRate": -0.02, "currency": "USD", "days": 1, "longCharge": "", "shortCharge": "", "units": ""},
            {"instrument": "UNKNOWN_CURRENCY", "longRate": 0.01, "shortRate": -0.02, "currency": "JPY", "days": 1, "longCharge": "", "shortCharge": "", "units": ""},
        ]
    }
    presenter_instance.filter_text = ""
    presenter_instance.selected_category = "All"
    ...
    mock_view.update_table.assert_called_once_with(expected_data)
    mock_view.set_status.assert_called_once_with("Display updated. Showing 3 instruments.")

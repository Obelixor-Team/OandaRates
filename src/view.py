from PyQt6.QtWidgets import (
    ...
    QLabel, QHeaderView, QDialog, QDialogButtonBox
)
...
class View(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.category_combo.addItems(["All", "Forex", "Indices", "Commodities", "Metals", "CFDs", "Bonds", "Other"])
        ...
        self.table.setHorizontalHeaderLabels(["Instrument", "Category", "Currency", "Days", "Long Rate", "Short Rate", "Long Charge", "Short Charge", "Units"])
        ...
        self.category_combo.currentTextChanged.connect(self.presenter.on_category_selected)
